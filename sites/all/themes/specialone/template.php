...
$theme_path = drupal_get_path('theme', 'specialone');
 ...
 */
function specialone_html_head_alter(&$head_elements) {
 ...
 *
 */
function specialone_preprocess_html(&$variables) {
  ...
  /**** Check the switcher settings ****/
  $switcher = theme_get_setting('switcher');
  
  if($switcher == "on") {
    drupal_add_js($path . '/js/demo-switcher.js', 'file');
  }
 ...
 */
function specialone_preprocess_page(&$variables) {
 ...
 */
function specialone_preprocess_node(&$variables) {
  ...
  if (variable_get('node_submitted_' . $node->type, TRUE)) {
    ...
    if (!empty($node->{'field_tags'})) {
      $tags = specialone_node_tags($node);
 ...
 */
function specialone_preprocess_maintenance_page(&$variables) {
  $path = path_to_theme();
  $color = theme_get_setting('theme_color');
 ...
 */
function specialone_breadcrumb($variables) {
 ...
 */
function specialone_feed_icon($variables) {
  $text = t('Subscribe to !feed-title', array('!feed-title' => $variables['title']));
  
  $image = "<i class=\"icon-rss\"></i>";
 ...
 */
function specialone_field__field_image($variables) {
 ...
 */
function specialone_field__field_blog_images($variables) {
 ...
 */
function specialone_field__field_portfolio_images($variables) {
 ...
 */
function specialone_field__field_portfolio_link($variables) {
 ...
 */
function specialone_field__field_portfolio_tag($variables) {
 ...
 */
function specialone_form_alter(&$form, &$form_state, $form_id) {
 ...
 */
function specialone_preprocess_button(&$vars) {
 ...
 */
function specialone_form_required_marker($variables) {
