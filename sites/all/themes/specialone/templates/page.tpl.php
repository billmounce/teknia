...
<div id="main-wrapper" class="container-fluid">
  ...
  <?php if( ($page['top_content_left'] && $page['top_content_right']) || ($breadcrumb_position === "left" && $page['top_content_right']) || ($breadcrumb_position === "right" && $page['top_content_left']) ) : ?>
	...
	<?php elseif( ($page['top_content_left'] && !$page['top_content_right'] && $breadcrumb_position !== "right") || ($breadcrumb_position === "left" && !$page['top_content_right']) ) : ?>
	...
	<?php elseif( ($page['top_content_right'] && !$page['top_content_left'] && $breadcrumb_position !== "left") || ($breadcrumb_position === "right" && !$page['top_content_left']) ) : ?>
      ...
      <div class="row-fluid wrapper">
        ...
        <div id="top-content-right-region" class="span12 text-right text-center-responsive">
          <?php if($breadcrumb_position === "right") { print $breadcrumb; } ?>
          <?php if($page['top_content_right']) { print render($page['top_content_right']); } ?>
        </div>
