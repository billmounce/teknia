...
<div id="main-wrapper" class="container-fluid">
  ...
  <?php if($page['top_content_left'] && $page['top_content_right']) : ?>
	...
	<!-- If only top-content-left region has content-->
	<?php elseif($page['top_content_left'] && !$page['top_content_right']) : ?>
	...
	<!-- If only top-content-left region has content-->
	<?php elseif($page['top_content_right'] && !$page['top_content_left']) : ?>
