...
(function($) {
    var MdSliderPanel = function() {
        ...
        this.textBoxTemplate = '<div class="slider-item ui-widget-content item-text" data-top="0" data-left="0" data-width="100" data-height="50" data-borderstyle="solid" data-type="text" data-title="Text" style="width: 100px; height: 50px;"><span class="md-text">Text</span><span class="sl-tl"></span><span class="sl-tr"></span><span class="sl-bl"></span><span class="sl-br"></span><span class="sl-top"></span><span class="sl-right"></span><span class="sl-bottom"></span><span class="sl-left"></span> </div>';
        ...
        this.setItemTitle = function(value) {
            if (this.selectedItem != null) {
                ...
                if($(this.selectedItem).data("type") == "text")
                    $(this.selectedItem).find(".md-text").html(value.replace(/\n/g, "<br />"));
